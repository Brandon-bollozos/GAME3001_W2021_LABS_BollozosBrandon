...
SpaceShip::SpaceShip()
{
	TextureManager::Instance()->load("../Assets/textures/Akarin.png", "Akarin");

	auto size = TextureManager::Instance()->getTextureSize("Akarin");
	setWidth(size.x);
	setHeight(size.y);
...
void SpaceShip::draw()
{
	TextureManager::Instance()->draw("Akarin", 
